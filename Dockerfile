...
RUN apt-get update && apt-get install -y git imagemagick wget tcl8.4 emacs && git clone https://github.com/HaukeBartsch/GoogleMapCreation.git && ln -s /usr/bin/tclsh8.4 /usr/bin/tclsh
